...
public class HyphenMatchers {
    public static final String M_HYPHENS;     //no spaces already grouped
    public static final String M_HYPHENSO;     //no spaces already grouped
    public static final String M_HYPHENS_UNDERSCORES_DOTS;     //no spaces already grouped
    public static final String M_HYPHENS_TO;     //no spaces already grouped
    public static final String M_HYPHENS_TO_UNTIL;     //no spaces already grouped
