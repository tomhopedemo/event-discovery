...
public class PhraseUtil {
    ...
    public static <T> List<Integer> indexesOfAll(T object, List<T> list) {
    ...
    public static String uppercaseAllWordsExcept(String input, List<String> except) {
    ...
    public static String subSentence(String sentence, int numberOfWords) {
    ...
    public static String removeWordSafely(String input, String wordToRemove) {
        return removeWordSafely(input, wordToRemove, false);
    }

    public static Double averageLengthWords(String title) {
        if (empty(title)) return null;
        return divide(title.length(), Util.bList(words(title)).size());
    }

    public static String removeWordSafely(String input, String wordToRemove, boolean caseInsensitive) {
        return replaceWordSafely(input, wordToRemove, caseInsensitive, " ");
    }

    public static String replaceWordSafely(String input, String wordToRemove, boolean caseInsensitive, String replacement) {
