...
public class Weekdays {
    public static final Util.MapList<String, String> WEEKDAYS_STANDARD_ENG;
    public static final Util.MapList<String, String> WEEKDAYS_STANDARD_DEU;
    ...
    static {
        WEEKDAYS_STANDARD_ENG = new Util.MapList<>();
        ...
        WEEKDAYS_STANDARD_DEU = new Util.MapList<>();
