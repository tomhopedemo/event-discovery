...
import static com.events.FiltersLists.REVERSE_ORDER;
import static com.events.FiltersLists.REVERSE_ORDER_SHORT;
import static com.events.Util.*;
import static java.lang.Integer.parseInt;

class AppDataGenerator {
    static void generateAppData(Util.MultiList<Multi<com.events.date.Calendar.Date, Time>, Multi<Event, Boolean>> dateTimeEvent, Map<String, String> filtered, Map<Util.Multi<String, com.events.date.Calendar.Date>, String> filteredByDate, Dirs dirs, InputData inputData) {
        MapList<com.events.date.Calendar.Date, Multi<Time, String>> dateEvent = new MapList<>();
        MapList<MultiA<String>, ScreenEvent> refDateTimeEvent = new MapList<>();
        for (Util.Multi<Util.Multi<com.events.date.Calendar.Date, Time>, Util.Multi<Event, Boolean>> multi : dateTimeEvent.underlying) {
    ...
    static String generateTimeDisplay(Util.Multi<Util.Multi<com.events.date.Calendar.Date, Time>, Util.Multi<Event, Boolean>> multi, String ref) {
        String timeDisplay;
    ...
    static class ScreenEvent {
        ...
        ScreenEvent(com.events.date.Calendar.Date date, Time time, String id, String title) {
            this.date = date;
            this.time = time;
            this.id = id;
            this.title = title;
    ...
    static class TitleSplitter {
        ...
        static Util.Multi<String, String> generateTitleUndertitle(Util.Multi<Util.Multi<com.events.date.Calendar.Date, Time>, Util.Multi<Event, Boolean>> multi) {
