...
abstract class TimeMatcher {
    ...
    static Time match(Util.StringMutable clean, Context.LanguageContext langCtx, Context.TimeContext timeCtx, boolean overall) {
    ...
    static Time matchAvoidIndices(Util.StringMutable clean, Context.LanguageContext langCtx, Context.TimeContext timeCtx) {
    ...
    static Time matchSingle(String text, boolean exactMatch, Context.LanguageContext langCtx, Context.TimeContext timeCtx) {
    ...
    static void cleanTimes(Util.StringMutable clean) {
    ...
    static List<Time> matchNoOverlaps(String text, Context.LanguageContext langCtx, Context.TimeContext timeCtx) {
    ...
    static List<Time> matchSingle(Util.StringMutable clean, Context.LanguageContext langCtx, Context.TimeContext timeCtx) {
        List<Time> times = Util.list();
        for (TimeMatcher matcher : matchersSingle(langCtx, timeCtx)) {
