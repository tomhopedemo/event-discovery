...
class Calendar {
    ...
    static int indexOf(CalendarDate calendarDate) {
        return DAY_CALENDAR.indexOf(calendarDate);
    }

    static int indexOf(Date date) {
    ...
    static List<CalendarDate> nextWeekdays(int weeks) {
    ...
    static void setDayOfWeek(Collection<Date> dates) {
    ...
    static void setDayOfWeek(Date date) {
    ...
    static CalendarDate currentCalendarDate() {
        return CURRENT_CALENDAR_DATE;
    }

    static CalendarDate get(int index) {
    ...
    static class CalendarDate {
        String dateDay;
        String dateMonth;
        String dateYear; //e.g. 1,2,...30//e.g. Oct, ...//e.g. 2017
        ...
        static int diffFromCurrent(Date date) {
    ...
    static class Date implements Serializable, Comparable<Date> {
        static String serialVersionUID = "2";
        String dateDay;
        String dateMonth;
        String dateYear; //e.g. 1,2,...30                //field 0//e.g. Oct, ...//e.g. 2017                    //field 2
        ...
        static Integer daysBetween(Date dateOne, Date dateTwo) {
            return daysBetween(list(dateOne, dateTwo));
        }

        static Date paddedDate(Date existingDate) {
        ...
        static Date previous(Date date) {
            int i = indexOf(date.toCalendarDate());
            if (i < 1) return null;
            return get(i - 1).toDate();
        }

        static Integer daysBetween(Collection<Date> days) {
        ...
        static List<Date> cloneMe(List<Date> dates) {
        ...
        static boolean strictlyBeforeAfterCheck(Date strictlyBefore, Date strictlyAfter) {
        ...
        static Date create(String dateRaw) {
