...
class WeekdaysSingleTime extends DateMatcher.DayTimeMatcher {
    Map<String, Time> match(String text) {         Map<String, Time> weekdayTimes = map();
        ...
        while (matcher.find()) { String day_of_week = WEEKDAYS_STANDARD_ENG.getKey(matcher.group(1));
            ...
            weekdayTimes.putIfAbsent(day_of_week, time);} return weekdayTimes;}}          //saturday(s) 7.30(pm)
