...
class DayWeekday extends DateMatcher {
    ...
    public DateMeta matchInternal(String text) { Util.MapList<String, String> weekdaysStandard = LANG_WEEKDAYS_STANDARD.get(language);
        ...
        while (matcher.find()) { Calendar.Date date = new Calendar.Date();
            ...
            meta.indexPairsInclExcl.add(multi);} return meta;}}