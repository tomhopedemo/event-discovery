...
class WeekdaysSingleTimeAmPm extends DateMatcher.DayTimeMatcher {
    Map<String, Time> match(String text) { Map<String, Time> weekdayTimes = map();
        ...
        while (matcher.find()) { String dayOfWeek = WEEKDAYS_STANDARD_ENG.getKey(matcher.group(1));
            ...
            weekdayTimes.putIfAbsent(dayOfWeek, time);} return weekdayTimes;}}     //saturday(s) 7pm