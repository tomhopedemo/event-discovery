...
import static com.arcta.events.ExecutionBlock.*;
import static com.arcta.events.Util.map;
class Manual { static String city = "london"; static String ref = "Ronnie Scotts";
    static String executionBlock = "a";
    static Map<String, ExecutionBlock> blocks = createExecutionBlocks();
    static Map<String,ExecutionBlock> createExecutionBlocks(){ Map<String,ExecutionBlock> blocks = map();
