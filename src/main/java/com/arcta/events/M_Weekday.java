...
class M_Weekday {
    static final String M_WEEKDAY_ENG;
    static final String M_WEEKDAY_DEU;
    static final String M_WEEKDAYO_ENG;
    static final String M_WEEKDAYO_SPACE_AFTER_ENG;
    static final String M_WEEKDAYO_SPACE_AFTER_DEU;
    static final String M_WEEKDAY_LONG;
    static final String M_WEEKDAYO_COMMA;
    static final String M_WEEKDAY_COMMA_SPACE_AFTER;
    static final String M_WEEKDAYO_COMMA_SPACE_AFTER_DEU;
