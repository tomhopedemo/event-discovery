...
class M_Static {
    static final List<String> MONTHS_LONG = Util.list("january", "february", "march", "april", "may", "june", "july", "august", "september", "october", "november", "december");
    ...
    static final Map<String, Integer> MONTH_DAY_MAP;
    static final Map<String, Calendar.Date> SEASONS;
    ...
    static final String M_DAY_MONTHO_YEARO;
    static final String M_DAY_MONTH_YEAR;
    static final String M_DAY_MONTH_YEARO;
    static final String M_DAYO_MONTH_YEARO;     // -------------- FULL DATE MATCHERS ----------------
    ...
    static {
        SEASONS = map();
        SEASONS.put("spring", new Calendar.Date("1", "mar", null));
        SEASONS.put("summer", new Calendar.Date("1", "jun", null));
        SEASONS.put("autumn", new Calendar.Date("1", "sep", null));
        SEASONS.put("winter", new Calendar.Date("1", "dec", null));
        MONTH_DAY_MAP = map();
    ...
    static List<String> order(Collection<String> collection) {
    ...
    static String constructMatcher(Util.MapList<String, String> input) {
        return constructMatcher(input, "|");
    }

    static String constructMatcher(Util.MapList<String, String> input, String delimiter) {
        return "(" + Util.string(order(input.listvalues()), delimiter) + ")";
    }

    static String constructMatcher(Map<String, String> input) {
        return constructMatcher(input, "|");
    }

    static String constructMatcher(Map<String, String> input, String delimiter) {
