...
class SingleDateMonth extends DateMatcher { Util.Lang language;
    ...
    public DateMeta matchInternal(String text) { List<Calendar.Date> dates = list();
        ...
        while (matcher.find()) { getIndexPairs(text, dateMeta, matcher);
            ...
            dates.add(date);}
        dateMeta.dateList = dates; return dateMeta;}}                              // 1 apr