...
class DataHtml {
    ...
    Util.PageData generateFestivalPageData(Calendar.Date date) {
    ...
    Util.PageData generatePageData(String data, Html.HtmlContext ctx, Calendar.CalendarDate baseDate) {
    ...
    List<DisplayEvent> filterAndSort(String data, Html.HtmlContext ctx, Calendar.CalendarDate baseDate, String city) {
    ...
    LinkedList<DisplayEvent> orderEvents(Html.HtmlContext ctx, Calendar.CalendarDate baseDate, List<DisplayEvent> events, String city) {
    ...
    List<DisplayEvent> generateFestivalEvents(Calendar.Date date) {
    ...
    List<String> loadFestivals(Calendar.Date date) {
        ...
        for (String festival : festivalDates.keySet()) {
            List<Calendar.Date> dates = festivalDates.get(festival);
    ...
    Map<String, List<Calendar.Date>> parseFestivalDates(List<String> refs) {
    ...
    LinkedList<DisplayEvent> orderEventsInCity(Calendar.CalendarDate baseDate, List<DisplayEvent> events) {
    ...
    static int numDatesAfterBaseDay(List<Calendar.Date> dates, Calendar.CalendarDate baseDate) {
