...
class M_Month {
    static final String M_MONTH_ENG;
    static final String M_MONTH_DEU;
    static final String M_MONTH_NEG_LOOKAHEAD;
    static final String M_MONTHO_ENG;
    static final String M_MONTHS_SPACE_BEFORE_AND_AFTER;
    static final String M_MONTHS_SPACE_AFTER;
